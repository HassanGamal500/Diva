...
class ProductAttributesController extends Controller
{
  ...
  public function display(Request $request){
    ...
    public function displayoptionsvaluesColor(Request $request){

        $title = array('pageTitle' => Lang::get("labels.Manage Values"));
        $data = $this->productsattribute->displayoptionsvalues($request);
        return view("admin.products_attributes.options.color.index",$title)->with('result', $data);

    }

    public function displayoptionsvaluesSize(Request $request){

        $title = array('pageTitle' => Lang::get("labels.Manage Values"));
        $data = $this->productsattribute->displayoptionsvalues($request);
        return view("admin.products_attributes.options.size.index",$title)->with('result', $data);
    ...
    public function insertoptionsvaluesColor(Request $request){

        $this->productsattribute->insertoptionsvaluesColor($request);
        return redirect()->back()->withErrors([Lang::get("labels.ValuesAddedMessage")]);
    }

    public function insertoptionsvaluesSize(Request $request){

        $this->productsattribute->insertoptionsvaluesSize($request);
        return redirect()->back()->withErrors([Lang::get("labels.ValuesAddedMessage")]);
    }
    ...
    public function editoptionsvaluesColor(Request $request){

        $title = array('pageTitle' => Lang::get("labels.Manage Options"));
        $result = $this->productsattribute->editoptionsvalues($request);
        return view("admin.products_attributes.options.color.edit",$title)->with('result', $result);
    }

    public function editoptionsvaluesSize(Request $request){

        $title = array('pageTitle' => Lang::get("labels.Manage Options"));
        $result = $this->productsattribute->editoptionsvalues($request);
        return view("admin.products_attributes.options.size.edit",$title)->with('result', $result);
    }
    ...
    public function updateoptionsvaluesColor(Request $request){

        $this->productsattribute->updateoptionsvaluesColor($request);
        return redirect()->back()->withErrors([Lang::get("labels.valueshasbeenupdatedMessage")]);
    }

    public function updateoptionsvaluesSize(Request $request){

        $this->productsattribute->updateoptionsvaluesSize($request);
        return redirect()->back()->withErrors([Lang::get("labels.valueshasbeenupdatedMessage")]);
    }

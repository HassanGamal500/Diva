                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          ...
                                          <div class="form-group" id="imageIcone">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.type of picture') }} <span style="color:red;">*</span></label>
                                                <div class="col-sm-10 col-md-8">
                                                    <div class="col-sm-6 col-md-6">
                                                        <select class="form-control field-validate" name="type">
                                                            <option value="" disabled selected>{{ trans('labels.Select') }}</option>
                                                            <option value="2">{{ trans('labels.More picture for product') }}</option>
                                                            <option value="1">{{ trans('labels.Pictures from Diva sources') }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>

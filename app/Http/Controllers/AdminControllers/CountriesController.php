...
class CountriesController extends Controller
{
    ...
    public function __construct(Countries $countries,Zones $zone,Tax_class $tax_class,Tax_rate $tax_rate, Languages $language, Setting $setting)
    {
    ...
    public function edit($id){
        ...
        // $brand_id = $request->id;
        $result['countries'] = $this->Countries->edit($id);
        $result['languages'] = $this->myVarsetting->getLanguages();
        return view("admin.countries.edit",$title)->with('result', $result);
    }

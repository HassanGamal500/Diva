...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'view_brand' => \App\Http\Middleware\brand\view_brand::class,
        'edit_brand' => \App\Http\Middleware\brand\edit_brand::class,
        'delete_brand' => \App\Http\Middleware\brand\delete_brand::class,
        'add_brand' => \App\Http\Middleware\brand\add_brand::class,
        'view_designer' => \App\Http\Middleware\designer\view_designer::class,
        'edit_designer' => \App\Http\Middleware\designer\edit_designer::class,
        'delete_designer' => \App\Http\Middleware\designer\delete_designer::class,
        'add_designer' => \App\Http\Middleware\designer\add_designer::class,
        'view_shipping' => \App\Http\Middleware\shippingMethod\view_shipping::class,
        'edit_shipping' => \App\Http\Middleware\shippingMethod\edit_shipping::class,
        'delete_shipping' => \App\Http\Middleware\shippingMethod\delete_shipping::class,
        'add_shipping' => \App\Http\Middleware\shippingMethod\add_shipping::class,
        'view_category' => \App\Http\Middleware\category\view_category::class,
        'edit_category' => \App\Http\Middleware\category\edit_category::class,
        'delete_category' => \App\Http\Middleware\category\delete_category::class,
        'add_category' => \App\Http\Middleware\category\add_category::class,

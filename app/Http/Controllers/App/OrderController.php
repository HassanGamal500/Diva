...
class OrderController extends Controller
{
	...
	public function orderDetail(Request $request){
		$orderResponse = Orders::orderDetail($request);
	   print $orderResponse;
   }
	...
	public function addToCart(Request $request){
    	$orderResponse = Orders::addToCart($request);
		print $orderResponse;
	}

	//Add To Cart
	public function myCart(Request $request){
    	$orderResponse = Orders::myCart($request);
		print $orderResponse;
	}

	//Delete Cart
	public function deleteCart(Request $request){
    	$orderResponse = Orders::deleteCart($request);
		print $orderResponse;
	}

	//Get Shipping Methods 
	public function shippingMethods(Request $request){
    	$orderResponse = Orders::shippingMethods($request);
		print $orderResponse;
	}

	//Refund Order 
	public function refund(Request $request){
    	$orderResponse = Orders::refund($request);
		print $orderResponse;
	}

<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      ?>
        <li class="treeview {{ Request::is('admin/customers/display') ? 'active' : '' }}  {{ Request::is('admin/customers/add') ? 'active' : '' }}  {{ Request::is('admin/customers/edit/*') ? 'active' : '' }} {{ Request::is('admin/customers/address/display/*') ? 'active' : '' }} {{ Request::is('admin/customers/filter') ? 'active' : '' }} {{ Request::is('admin/customers/seller') ? 'active' : '' }}">
          <a href="#">
            <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.link_customers') }}</span><i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="{{ Request::is('admin/customers/display') ? 'active' : '' }} {{ Request::is('admin/customers/edit/*') ? 'active' : '' }} {{ Request::is('admin/customers/address/display/*') ? 'active' : '' }} {{ Request::is('admin/customers/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/customers/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_customers') }}</a></li>
            <li class="{{ Request::is('admin/customers/add') ? 'active' : '' }}"><a href="{{ URL::to('admin/customers/add')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.Add customer') }}</a></li>
            <!--<li class="{{ Request::is('admin/customers/seller') ? 'active' : '' }}"><a href="{{ URL::to('admin/customers/seller')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.Request Seller') }}</a></li>-->
          </ul>
        </li>
      <?php } ?>

      <?php
        if($check->category_view == 1){
      ?>
        <li class="treeview {{ Request::is('admin/categories/display') ? 'active' : '' }} {{ Request::is('admin/categories/displaySub') ? 'active' : '' }} {{ Request::is('admin/categories/add') ? 'active' : '' }} {{ Request::is('admin/categories/edit/*') ? 'active' : '' }} {{ Request::is('admin/categories/filter') ? 'active' : '' }} ">
          <a href="#">
            <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.link_main_categories') }}</span><i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="{{ Request::is('admin/categories/display') ? 'active' : '' }} {{ Request::is('admin/categories/add') ? 'active' : '' }} {{ Request::is('admin/categories/edit/*') ? 'active' : '' }} {{ Request::is('admin/categories/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/categories/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.main categories') }}</a></li>
            <li class="{{ Request::is('admin/categories/displaySub') ? 'active' : '' }} {{ Request::is('admin/categories/add') ? 'active' : '' }} {{ Request::is('admin/categories/edit/*') ? 'active' : '' }} {{ Request::is('admin/categories/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/categories/displaySub')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.sub categories') }}</a></li>
          </ul>
        </li>
      <?php } ?>

      <?php
      if($check->brand_view == 1){
      ?>
      <li class="treeview {{ Request::is('admin/brands/display') ? 'active' : '' }} {{ Request::is('admin/brands/add') ? 'active' : '' }} {{ Request::is('admin/brands/edit/*') ? 'active' : '' }} ">
        <a href="{{ URL::to('admin/brands/display')}}">
          <i class="fa fa-industry" aria-hidden="true"></i> <span>{{ trans('labels.link_brand') }}</span>
        </a>
      </li>
    <?php } ?>
    
    <?php
      if($check->designer_view == 1){
      ?>
      <li class="treeview {{ Request::is('admin/designers/display') ? 'active' : '' }} {{ Request::is('admin/designers/add') ? 'active' : '' }} {{ Request::is('admin/designers/edit/*') ? 'active' : '' }} ">
        <a href="{{ URL::to('admin/designers/display')}}">
          <i class="fa fa-industry" aria-hidden="true"></i> <span>{{ trans('labels.designers') }}</span>
        </a>
      </li>
    <?php } ?>
      ...
      ?>
        <li class="treeview {{ Request::is('admin/products/display') ? 'active' : '' }} {{ Request::is('admin/products/displayCustomer') ? 'active' : '' }} {{ Request::is('admin/products/add') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/products/attributes/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} {{ Request::is('admin/products/conditions/*') ? 'active' : '' }} {{ Request::is('admin/reviews/display') ? 'active' : '' }}">
          <a href="#">
            <i class="fa fa-database" aria-hidden="true"></i> <span>{{ trans('labels.link_products') }}</span><i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="{{ Request::is('admin/products/display') ? 'active' : '' }} {{ Request::is('admin/products/displayCustomer') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/products/filter') ? 'active' : '' }}">
              <a href="#">
                <i class="fa fa-circle-o" aria-hidden="true"></i> <span>{{ trans('labels.link_products') }}</span><i class="fa fa-angle-left pull-right"></i>
                <ul class="treeview-menu">
                  <li class="treeview {{ Request::is('admin/products/display') ? 'active' : '' }} {{ Request::is('admin/products/add') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/products/attributes/add/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} ">
                      <a href="{{ URL::to('admin/products/display')}}">
                          <i class="fa fa-circle-o" aria-hidden="true"></i> <span> {{ trans('labels.link_products') }} </span>
                      </a>
                  </li>
                  <li class="treeview {{ Request::is('admin/products/displayCustomer') ? 'active' : '' }} {{ Request::is('admin/products/add') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/products/attributes/add/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} ">
                    <a href="{{ URL::to('admin/products/displayCustomer')}}">
                        <i class="fa fa-circle-o" aria-hidden="true"></i> <span> {{ trans('labels.product for customer') }} </span>
                    </a>
                </li>
                </ul>
              </a>
            </li>
            <li class="{{ Request::is('admin/products/attributes/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/attributes/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.products_attributes') }}</a></li>
            ...
            {{-- <li class="{{ Request::is('admin/products/seller') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/seller')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.Request Seller') }}</a></li> --}}
            <li class="{{ Request::is('admin/products/conditions/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/conditions/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.Condition') }}</a></li>
            <li class="{{ Request::is('admin/reviews/display') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/reviews/display')}}">
                <i class="fa fa-circle-o" aria-hidden="true"></i> <span>{{ trans('labels.reviews') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@if($status_check)<span class="label label-success">{{ trans('labels.new') }}</span>@endif
              </a>
            </li>
          </ul>
        </li>
      ...
      ?>
        <li class="treeview {{ Request::is('admin/shippingmethods/display') ? 'active' : '' }} {{ Request::is('admin/shippingmethods/add/*') ? 'active' : '' }} {{ Request::is('admin/shippingmethods/edit/*') ? 'active' : '' }}">
      ...
      <?php
        ...
        if($check->orders_view == 1){
      ?>
        <li class="treeview {{ Request::is('admin/retuenUnit/display') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/retuenUnit/display')}}"><i class="fa fa-truck" aria-hidden="true"></i> <span> {{ trans('labels.Return Units') }}</span>
          </a>
        </li>
      <?php } ?>
      ...
      <?php 
        $status_check = DB::table('contacts')->where('contact_read',0)->count();
        $website = DB::table('contacts')->where('contact_read',0)->where('contact_from', '=', 0)->count();
        $app = DB::table('contacts')->where('contact_read',0)->where('contact_from', '=', 1)->count();
      ?>
        <li class="treeview {{ Request::is('admin/contacts_website/display') ? 'active' : '' }} {{ Request::is('admin/contacts_app/display') ? 'active' : '' }}">
            <a href="#">
              <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.contacts') }}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@if($status_check > 0)<span class="label label-success">{{ trans('labels.new') }}</span>@endif
            </a>
            <ul class="treeview-menu">
                <li class="{{ Request::is('admin/contacts_website/display') ? 'active' : '' }}"><a href="{{ URL::to('admin/contacts_website/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.contacts_website') }}</a></li>
                <li class="{{ Request::is('admin/contacts_app/display') ? 'active' : '' }}"><a href="{{ URL::to('admin/contacts_app/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.contacts_app') }}</a></li>
            </ul>
        </li>
      <?php  ?>
  ...
  <span>{{ trans('labels.link_reports') }}</span> <i class="fa fa-angle-left pull-right"></i>
      ...
      ?>
        ...
        <li class="treeview {{ Request::is('admin/faqs') ? 'active' : '' }} {{ Request::is('admin/addfaq') ? 'active' : '' }} {{ Request::is('admin/editfaq/*') ? 'active' : '' }} {{ Request::is('admin/partners') ? 'active' : '' }} {{ Request::is('admin/addpartner') ? 'active' : '' }} {{ Request::is('admin/editpartner/*') ? 'active' : '' }} {{ Request::is('admin/teams') ? 'active' : '' }} {{ Request::is('admin/editteam/*') ? 'active' : '' }} {{ Request::is('admin/addteam') ? 'active' : '' }} {{ Request::is('admin/teams/*') ? 'active' : '' }} {{ Request::is('admin/blogs') ? 'active' : '' }} {{ Request::is('admin/addblog') ? 'active' : '' }} {{ Request::is('admin/editblog/*') ? 'active' : '' }} {{ Request::is('admin/blogs/*') ? 'active' : '' }} {{ Request::is('admin/aboutus') ? 'active' : '' }} {{ Request::is('admin/sliders') ? 'active' : '' }} {{ Request::is('admin/addsliderimage') ? 'active' : '' }} {{ Request::is('admin/editslide/*') ? 'active' : '' }} {{ Request::is('admin/webpages') ? 'active' : '' }}  {{ Request::is('admin/addwebpage') ? 'active' : '' }}  {{ Request::is('admin/editwebpage/*') ? 'active' : '' }} {{ Request::is('admin/websettings') ? 'active' : '' }} {{ Request::is('admin/webthemes') ? 'active' : '' }} {{ Request::is('admin/customstyle') ? 'active' : '' }} {{ Request::is('admin/constantbanners') ? 'active' : '' }} {{ Request::is('admin/addconstantbanner') ? 'active' : '' }} {{ Request::is('admin/editconstantbanner/*') ? 'active' : '' }}" >
          <a href="#">
            <i class="fa fa-gears" aria-hidden="true"></i>
            <span> {{ trans('labels.link_site_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="{{ Request::is('admin/constantbanners') ? 'active' : '' }} {{ Request::is('admin/constantbanners/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/constantbanners')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_Banners') }}</a></li>

            <li class="{{ Request::is('admin/blogs') ? 'active' : '' }} {{ Request::is('admin/blogs/*') ? 'active' : '' }} {{ Request::is('admin/addblog') ? 'active' : '' }} {{ Request::is('admin/editblog/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/blogs')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_blogs') }}</a></li>

            <li class="{{ Request::is('admin/aboutus') ? 'active' : '' }} {{ Request::is('admin/aboutus') ? 'active' : '' }} {{ Request::is('admin/aboutus/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/aboutus')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_aboutUs') }}</a></li>

            <li class="{{ Request::is('admin/teams') ? 'active' : '' }} {{ Request::is('admin/addteam') ? 'active' : '' }} {{ Request::is('admin/editteam/*') ? 'active' : '' }} {{ Request::is('admin/teams/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/teams')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_teams') }}</a></li>

            <li class="{{ Request::is('admin/partners') ? 'active' : '' }} {{ Request::is('admin/addpartner') ? 'active' : '' }} {{ Request::is('admin/editpartner/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/partners')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_partners') }}</a></li>
            
            <li class="{{ Request::is('admin/faqs') ? 'active' : '' }} {{ Request::is('admin/addfaq') ? 'active' : '' }} {{ Request::is('admin/editfaq/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/faqs')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_faqs') }}</a></li>

                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!--<td>{{ $listingCustomers->numOfOrders }}</td>-->
                                            <!--<td>{{ $listingCustomers->wallet }}  @if (App::isLocale('en')) {{$customers['currency']->symbol_left }} @else {{$customers['currency']->symbol_right }} @endif</td>-->
                                            <td>
                                                <ul class="nav table-nav">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li role="presentation" class="divider"></li>
                                                            <?php $check =  DB::table('manage_role')->where('user_types_id',Auth()->user()->role_id)->first(); ?>
                                                            @if($check->orders_view == 1)
                                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url('admin/orders/display') }}/{{$listingCustomers->id}}">{{ trans('labels.orders') }}</a></li>
                                                            <li role="presentation" class="divider"></li>
                                                            @endif

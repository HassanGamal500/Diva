...
class Languages extends Model
{
    ...
    public function paginator(){
      $languages = Languages::sortable(['languages_id'=>'desc'])
            ...
            ->select('languages.languages_id','language_description.name','languages.code', 'languages.directory','languages.is_default','languages.direction','languages.status','languages.sort_order','image_categories.path')
    ...
    public function getter(){
      $languages = Languages::sortable(['languages_id'=>'asc'])
        ->leftJoin('language_description', 'language_description.languages_id', '=', 'languages.languages_id')    
        ->leftJoin('images','images.id', '=', 'languages.image')
        ->leftJoin('image_categories','image_categories.image_id', '=', 'languages.image')
        ->select('languages.languages_id','language_description.name','languages.code','languages.status','languages.directory','languages.is_default','languages.direction','languages.sort_order')
        ->where('language_id', '=', language())
        ->get();
        return $languages;
    }

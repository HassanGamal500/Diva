        ...
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="{{asset('admin/lang/en')}}">{{ trans('labels.English')}}</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="{{asset('admin/lang/ar')}}">{{ trans('labels.Arabic')}}</a>
            </div>
          </li>
              ...
              {{-- <li class="user-body">
                <div class="row">
                  <div class="col-xs-6 text-center">
                    <a href="{{asset('lang/en')}}">{{ trans('labels.English')}}</a>
                  </div>
                  <div class="col-xs-6 text-center">
                    <a href="{{asset('lang/ar')}}">{{ trans('labels.Arabic')}}</a>
                  </div>
                </div>
                <!-- /.row -->
              </li> --}}

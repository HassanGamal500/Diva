        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-red">
                    <div class="inner">
                      <h3>{{ $result['contacts'] }} </h3>
                      <p>{{ trans('labels.contacts') }}</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                    </div>
                    <a href="{{ URL::to('admin/contacts/display')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.contacts') }}">{{ trans('labels.contacts') }} <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-4 col-xs-6">
                ...
                <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-purple">
                      <div class="inner">
                        ...
                        <p>{{ trans('labels.link_brand') }}</p>
                      </div>
                      <div class="icon">
                        <i class="fa fa-industry"></i>
                      </div>
                      <a href="{{ URL::to('admin/brands/display')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.viewAllBrands') }}">{{ trans('labels.viewAllBrands') }} <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                @if(Auth()->user()->id==2)
                  <!-- ./col -->
                  <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-maroon">
                      <div class="inner">
                        <h3>{{ $result['shipping_methods'] }}</h3>
  
                        <p>{{ trans('labels.link_shipping_methods') }}</p>
                      </div>
                      <div class="icon">
                        <i class="fa fa-truck"></i>
                      </div>
                      <a href="{{ URL::to('admin/shippingmethods/display')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.viewAllShippingMethods') }}">{{ trans('labels.viewAllShippingMethods') }} <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-orange">
                      <div class="inner">
                        <h3>{{ $result['returns'] }}</h3>
  
                        <p>{{ trans('labels.returnUnits') }}</p>
                      </div>
                      <div class="icon">
                        <i class="fa fa-truck"></i>
                      </div>
                      <a href="{{ URL::to('admin/retuenUnit/display')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.viewAllReturnUnit') }}">{{ trans('labels.viewAllReturnUnit') }} <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  @endif
                  <!-- ./col -->
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ trans('labels.TopFiveCustomer') }}</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ trans('labels.CustomerName') }}</th>
                                        <th>{{ trans('labels.TotalOrders') }}</th>
                                        <th>{{ trans('labels.detail') }}</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @if(count($result['topUsers'])>0)
                                        @foreach($result['topUsers'] as $user)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $user->info->first_name }} {{ $user->info->first_name }}</td>
                                                <td>{{ $user->user_count }}</td>
                                                <td><a href="{{ URL::to('admin/customers/edit/') }}/{{ $user->id }}" class="btn btn-sm btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Go to detail">{{ trans('labels.detail') }}</a></td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
                                            <td colspan="4">{{ trans('labels.noCustomerPlaced') }}</td>

...
class OrdersController extends Controller
{
    ...
    public function displayByUser($id)
    {
    ...
    // All Orders By Shipping ID 
    public function displayByShipping($id)
    {
        ...
        $orders = DB::table('orders')->orderBy('created_at', 'DESC')
            ->where('shipping_method', '=', $id)->paginate(40);
    ...
    public function vieworder(Request $request)
    {
        ...
        foreach ($order as $data) {
            ...
            $orders_products = DB::table('orders_products')
                ...
                ->select('orders_products.*', 'products_image as image')

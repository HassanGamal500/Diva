...
class Location extends Model
{
	...
	public static function addshippingaddress($request)
	{
		...
		$entry_state             				=   $request->entry_status;
		...
		if($authenticate==1){
			...
			$responseData = array('status'=>'1', 'data'=>array(), 'message'=>"Shipping address has been added successfully!");
		}else{
	...
	public static function updateshippingaddress($request)
	{
		...
		if ($validator->fails()){
			...
			if($authenticate==1){
				...
				$responseData = array('status'=>'1', 'data'=>array(), 'message'=>"Shipping address has been updated successfully!");
			}else{
				$responseData = array('status'=>'0', 'data'=>array(),  'message'=>"Unauthenticated call.");
			}
			$shippingResponse = json_encode($responseData);
	...
	public static function deleteshippingaddress($request)
	{
		...
		if($authenticate==1){
			...
			$responseData = array('status'=>'1', 'data'=>array(), 'message'=>"Shipping address has been deleted successfully!");
		}else{
			$responseData = array('status'=>'0', 'data'=>array(),  'message'=>"Unauthenticated call.");
		}
		$shippingResponse = json_encode($responseData);
	...
	public static function getalladdress($request)
	{
		...
		if($authenticate==1){
			...
			if(count($addresses)>0){
				...
				$responseData = array('status'=>'1', 'data'=>$addresses_data, 'message'=>"Return shipping addresses successfully");
			}else{
				$addresses_data = array();
				$responseData = array('status'=>'0', 'data'=>$addresses_data, 'message'=>"Addresses are not added yet.");
			}
		}else{
			$responseData = array('status'=>'0', 'data'=>array(),  'message'=>"Unauthenticated call.");
		}
	...
	public static function updatedefaultaddress($request)
	{
		...
		if($authenticate==1){
			...
			$responseData = array('status'=>'1', 'data'=>array(), 'message'=>"Default address has been changed successfully!");
		}else{
			$responseData = array('status'=>'0', 'data'=>array(),  'message'=>"Unauthenticated call.");
		}		
		...
		if ($validator->fails()){
  		...
  		if($authenticate==1){
			...
			$countries = DB::table('countries')->get();
  			...
  			$responseData = array('status'=>'1', 'data'=>$countries, 'message'=>"Returned all countries.");
  		}else{
  			$responseData = array('status'=>'0', 'data'=>array(),  'message'=>"Unauthenticated call.");
  		}
		$response = json_encode($responseData);
	...
	public static function zones($request)
	{
		...
		if ($validator->fails()){
  		...
  		if($authenticate==1){
			...
			$responseData = array('status'=>'1', 'data'=>$zones, 'message'=>"Returned all states.");
  		}else{
  			$responseData = array('status'=>'0', 'data'=>array(),  'message'=>"Unauthenticated call.");
  		}
		$response = json_encode($responseData);

...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.ShippingMethod') }}  <small>{{ trans('labels.EditCurrentShippingMethod') }}...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/shippingmethods/display')}}"><i class="fa fa-industry"></i> {{ trans('labels.ShippingMethods') }}</a></li>
                <li class="active">{{ trans('labels.EditShippingMethod') }}</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.EditShippingMethodInfo') }} </h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::hidden('id',  $editShipping[0]->id , array('class'=>'form-control', 'id'=>'id')) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input name="shipping_name[{{$languages->languages_id}}]" type="text" class="form-control field-validate" id="shippingName" value="{{ $editShipping[$languages->languages_id - 1]->name }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input name="shipping_phone" type="text" class="form-control field-validate" id="shippingPhone" value="{{ $editShipping[0]->phone }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input name="shipping_email" type="text" class="form-control field-validate" id="shippingPhone" value="{{ $editShipping[0]->email }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input name="shipping_price" type="text" class="form-control field-validate" id="shippingPhone" value="{{ $editShipping[0]->price }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="isActive">
                                                        <option value="1" @if($editShipping[0]->status == 1) selected @endif>{{ trans('labels.Active') }}</option>
                                                        <option value="0" @if($editShipping[0]->status == 0) selected @endif>{{ trans('labels.Inactive') }}</option>
                                                    </select>

                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-info"><br>
                                        ...
                                        <div class="box-body">
                                            {!! Form::open(array('url' =>'admin/products/attributes/options/values/updateColor', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            @endforeach
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Choose Color') }} </label>
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="color" name="color_code" class="form-control field-validate" value="{{$result['editoptions'][0]->products_options_values_color}}" required>
                                                </div>
                                            </div>
                                        <!-- /.box-body -->
                                            <div class="box-footer text-center">
                                                <button type="submit" class="btn btn-primary">{{ trans('labels.Submit') }}</button>
                                                <a href="{{ URL::to("admin/products/attributes/options/values/displayColor/".$result['editoptions'][0]->products_options_id)}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>

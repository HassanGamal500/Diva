                                                    ...
                                                    <td dir="ltr">
                                                        @if($data->products_options_id == 1)
                                                            @foreach($data->data as $language)
                                                                ...
                                                                <br>
                                                            @endforeach
                                                            <strong>{{trans('labels.Color Code')}} : </strong>
                                                            @foreach ($data->colorAndSize as $item)
                                                                @if ($item->products_options_values_color != "")
                                                                    {{$item->products_options_values_color}},
                                                                @else
                                                                    ---,
                                                                @endif
                                                            ...
                                                            @endforeach
                                                            <br>
                                                        @elseif($data->products_options_id == 4)
                                                            <strong>{{trans('labels.Size')}} : </strong>
                                                            @foreach ($data->colorAndSize as $item)
                                                                @if ($item->products_options_values_size != "")
                                                                    {{$item->products_options_values_size}},
                                                                @else
                                                                    ---,
                                                                @endif
                                                            @endforeach
                                                        ...
                                                        @if($data->products_options_id == 1)
                                                            <a href="{{ URL::to('admin/products/attributes/options/values/displayColor')}}/{{$data->products_options_id}}" >{{ trans('labels.Manage Values') }}</a><br>
                                                        @elseif($data->products_options_id == 4)
                                                            <a href="{{ URL::to('admin/products/attributes/options/values/displaySize')}}/{{$data->products_options_id}}" >{{ trans('labels.Manage Values') }}</a><br>
                                                        @else
                                                            <a href="{{ URL::to('admin/products/attributes/options/values/display')}}/{{$data->products_options_id}}" >{{ trans('labels.Manage Values') }}</a><br>
                                                        @endif
                                                    </td>
                                                    <!--<td>-->
                                                    <!--    @if($data->products_options_id != 1 && $data->products_options_id != 4)-->

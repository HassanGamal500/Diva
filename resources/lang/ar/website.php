...
return [
    ...
    */
    'app name'=>'ديفا',
    'thankYou'=>'شكرا لك',
    'Returns & Refunds'=>'سياسة الاسترجاع',

    'FAQ’s'=>'الأسئلة',
    'Customer Services'=>'خدمات العملاء',
    'Our Application'=>'التطبيقات',
    'App Store'=>'متجر ابل',
    'Google Play'=>'متجر جوجيل',
    'Social Media'=>'وسائل التواصل',
    'Twitter'=>'تويتر',
    'Facebook'=>'فيسبوك',
    'Instgram'=>'انستجرام',
    'Developed by'=>'التصميم و التطوير بواسطة',
    ...
    'Download Text'=>'قم بتحمبل تطبيقنا الرائع من المتجر الآن!',
    'Enter your email address'=>'أدخل عنوان بريدك الالكتروني',
    "Let's stay in toutch"=>"دعونا نبقى على اتصال",
    "Let's stay in toutch text"=>"أدخل عنوان بريدك الإلكتروني للانضمام إلى قائمتنا البريدية والحفاظ على تحديث نفسك",
    'IRONDOT'=>'ايرون دوت',
    'Our Value'=>'اهدفنا',
    'Our Mission'=>'مهمتنا',
    'Our Vision'=>'رؤيتنا',
    ...
    'Let\'s stay in touch'=>"دعونا نبقى على اتصال",
    'Let\'s stay in touch text' => "أدخل عنوان بريدك الإلكتروني للانضمام إلى قائمتنا البريدية والحفاظ على تحديث نفسك",
	...
	'Invite code' => 'كود الدعوه',
	'Enter your phone number and we will send verification code for reset password' => 'أدخل رقم هاتفك وسنرسل رمز التحقق لإعادة تعيين كلمة المرور',
	'Verification Code' => 'رمز التحقق',
	'Verification code has been sent to your phone' => 'تم إرسال رمز التحقق إلى هاتفك',
	'Resend' => 'إعادة إرسال',
	'Reset Password' => 'إعادة تعيين كلمة المرور',
	'Set your new password and you will return to login' => 'قم بتعيين كلمة المرور الجديدة وسوف تعود لتسجيل الدخول',
	'Repassword' => 'إعادة كلمة المرور',
    'Save' => 'حفظ',
    'faqs' => 'الاسئلة الشائعة',
    'How Do We Work' => 'كيف نعمل',
    
    'Select Message' => 'اختر نوع الرساله',
    'Select' => 'اختر',
    'problem' => 'مشكله',
	'suggestion' => 'اقتراح',

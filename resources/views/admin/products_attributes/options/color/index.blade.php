                ...
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    {!! Form::open(array('url' =>'admin/products/attributes/options/values/insertColor', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Choose Color') }} </label>
                                        <div class="col-sm-10 col-md-8">
                                            <input type="color" name="color_code" class="form-control field-validate" required>
                                        </div>
                                    </div>
                                            ...
                                            @foreach($result['content'] as $data)
                                                ...
                                                <tr id="tr_parent_{{$data->products_options_values_id}}">
                                                    ...
                                                    <td dir="ltr">
                                                        ...
                                                        @endforeach
                                                        <strong>{{ trans('labels.Color Code') }}:</strong>{{$data->products_options_values_color}}
                                                    </td>
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="" href="{{ URL::to('admin/products/attributes/options/values/editColor')}}/{{$data->products_options_values_id}}" class="badge bg-light-blue" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

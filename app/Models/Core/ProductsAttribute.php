...
class ProductsAttribute extends Model
{
    ...
    public function display($request){
        ...
        foreach($attributes as $attributes_data){
            ...
            $result2 = array();
            $index2 = 0;
            $colorAndSize = DB::table('products_options_values')
                ->where('products_options_id','=',$attributes_data->products_options_id)
                ->get();
            $result[$index]->colorAndSize =$colorAndSize;
            foreach($languages as $language){
                ...
                $values = DB::table('products_options_values')
                    ...
                    ->select('products_options_values_descriptions.*', 'products_options_values.*')
                    ->where('language_id','=',$language->languages_id)
    ...
    public function insertoptionsvaluesColor($request){
        $result = array();
        $languages =  $this->myVarsetting->getLanguages();
        $i = 0;
        //multiple lanugauge with record
        foreach($languages as $languages_data){
            ...
            if($i==0){
                ...
                $products_options_values_id = DB::table('products_options_values')->insertGetId([
                    'products_options_values_name' => $requ_products_options_values_name,
                    'products_options_id' => $request->products_options_id,
                    'products_options_values_color' => $request->color_code
                ]);                      
                $i++;
            }
            $requ_products_options_values_name = $request->$products_options_values_name;
    ...
    public function insertoptionsvaluesSize($request){
        $result = array();
        $languages =  $this->myVarsetting->getLanguages();
        $i = 0;
        //multiple lanugauge with record
        foreach($languages as $languages_data){
            ...
            if($i==0){
                $requ_products_options_values_name = $request->$products_options_values_name;
                $products_options_values_id = DB::table('products_options_values')->insertGetId([
                    'products_options_values_name' => $request->size,
                    'products_options_id' => $request->products_options_id,
                    'products_options_values_size' => $request->size
                ]);                      
                $i++;
            }
            $requ_products_options_values_name = $request->$products_options_values_name;
            DB::table('products_options_values_descriptions')->insert([
                'options_values_name' => $request->size,
                'products_options_values_id' => $products_options_values_id,
                'language_id' => $languages_data->languages_id
            ]);
        }
    ...
    public function updateoptionsvaluesColor($request){
        $products_options_values_id = $request->products_options_values_id;
        $languages =  $this->myVarsetting->getLanguages();
        $products_options_values = DB::table('products_options_values')
    ...
    public function updateoptionsvaluesSize($request){
        $products_options_values_id = $request->products_options_values_id;
        $languages =  $this->myVarsetting->getLanguages();
        $products_options_values = DB::table('products_options_values')
            ->where('products_options_values_id', '=', $products_options_values_id)

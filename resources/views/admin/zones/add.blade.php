                                    ...
                                    <div class="box box-info"><br>
                                      ...
                                      @endif
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ZoneName') }} ({{ $languages->name }})
                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                                    <input name="zone_name[{{$languages->languages_id}}]" type="text" class="form-control field-validate" id="zone_name" value="{{old('zone_name.'.$languages->languages_id.'')}}">
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
